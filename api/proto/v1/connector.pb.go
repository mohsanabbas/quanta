...
// Deprecated: Use ConnectorAck.ProtoReflect.Descriptor instead.
...
var file_v1_connector_proto_goTypes = []any{
	(*ConnectorAck)(nil),    // 0: quanta.v1.ConnectorAck
	(*CheckpointToken)(nil), // 1: quanta.v1.CheckpointToken
	(*Frame)(nil),           // 2: quanta.v1.Frame
}
var file_v1_connector_proto_depIdxs = []int32{
	1, // 0: quanta.v1.ConnectorAck.checkpoint:type_name -> quanta.v1.CheckpointToken
	2, // 1: quanta.v1.Connector.Stream:input_type -> quanta.v1.Frame
	0, // 2: quanta.v1.Connector.Stream:output_type -> quanta.v1.ConnectorAck
